...
class Mqtt_client():
    ...
    def on_message(self, client, userdata, msg):
        ...
        mainwin.connectionDock.textQuestion.setText(json.loads(m_decode)['message'])
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self, mc):
        ...
        self.ePushtbtn = QPushButton(f"SEND {DEVICE_NAME}", self)
        ...
        self.textQuestion = QLineEdit()
        self.textQuestion.setText('')
        self.textInput = QLineEdit()
        self.textInput.setText('please open the door !')
        ...
        formLayot.addRow("Question", self.textQuestion)
        formLayot.addRow("Text to send", self.textInput)
    ...
    def device_switch_status(self):
        ...
        self.mc.publish_to(self.ePublisherTopic.text(), json.dumps({'device': DEVICE_NAME, 'message': self.textInput.text()}))
